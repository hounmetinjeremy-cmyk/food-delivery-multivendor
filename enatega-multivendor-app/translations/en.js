export const en = {
  ...
  mobileErrFormat: "Doesn't match this country. Try: {{example}}",
  ...
  newMessageFromRider: 'New message from rider',
  permissionRequired: 'Permission Required',
  galleryPermissionMessage: 'Please allow photo library access to attach images.',
  imageUploadFailed: 'Image upload failed. Please try again.',
  uploadingImage: 'Uploading image...',
  imagePickerUnavailable: 'Please update to the latest app build to attach images.',
  ...
  managePasswordLanguagePreferences: 'Manage your password, language, and privacy preferences',
  edit_name_subtitle: 'Update the name displayed on your account.',
  changePasswordDescription: 'Choose a strong password to keep your account secure.',
  oauthLoginDetected: '{{provider}} login detected',
  oauthPasswordChangeMessage: 'Your password is managed by {{provider}}. Change it from your {{provider}} account.',
  verification_code_msg: 'We will send a verification code to this number.',
  multiVendor: 'Multi Vendor',
  singleVendor: 'Single Vendor',
  applePay: 'Apple Pay',
  ...
  found: 'found',
  billed: 'billed',
  thanksForUsing: 'Thank you for using the app.',
